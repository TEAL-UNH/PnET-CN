...
public:
	...
	int modeltype;  // model type, 0: pnet-day, 1: pnet-ii, 2: pnet-cn
	...
	typedef struct
	{
		...
		double CanopyDO3Pot;			// O3 effect on photosynthesis for the whole canopy
		...
		double PARYr;			// annual average air Par, umol m-2 s-1 at daytime
